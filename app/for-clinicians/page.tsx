    ...
    <div className="min-h-screen bg-[#0a0f1a] text-slate-100">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert max-w-none text-white/80 space-y-8">
          ...
          {/* New ancestry note section for Tier 1 */}
          <section>
            <h2 className="text-2xl font-semibold tracking-tight text-white">Ancestry and Population Considerations</h2>
            <p>
              Most underlying genetic association data in this tool comes from European-ancestry study populations. Effect sizes, allele frequencies, and clinical relevance can differ substantially in other ancestry groups. Findings should be interpreted with particular caution for patients whose ancestry is not well represented in the source GWAS data. The Evidence Badges and Limitations sections in the patient-facing report flag ancestry limitations where known.
            </p>
            <p className="text-sm text-white/60 mt-2">
              <strong>Important:</strong> Most genetic associations in reports generated by this tool are based primarily on European-ancestry studies. Applicability to other ancestries may be limited or unknown. Results should be interpreted with caution in non-European populations.
            </p>
          </section>
        </div>
