      ...
      <AnimatePresence>
        {result && displayResult && (
          <div id="results" className="max-w-6xl mx-auto px-6 pt-10 pb-20 result-section">
            ...
            {/* Phase 2 Integration: View Switcher */}
            ...
            {viewMode === 'raw' ? (
              ...
              <div className="space-y-6">
                ...
                {/* More profiles will be added here in future increments */}
                <div className="text-xs text-white/50 text-center pt-2">More synthesized profiles (Drug Metabolism, Sleep, etc.) coming soon.</div>
              </div>
            )}
